...
CREATE TABLE `announcement` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='公告新闻通知';
...
CREATE TABLE `appeal` (
  ...
  `images` varchar(1000) DEFAULT NULL COMMENT '申诉图片,逗号分隔',
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='申诉';
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `appeal` VALUES (4,9,4,'当时接到家人紧急电话不得不接听，已经使用了蓝牙耳机，并未影响驾驶安全，请管理员重新审核',NULL,0,NULL,NULL,NULL,'2026-04-09 21:00:00','2026-04-10 10:47:56'),(5,10,5,'当时二环严重拥堵，导航推荐走三环绕行，实际上节省了20分钟时间，并非故意绕路',NULL,1,'申诉成立，经核实当时二环确实拥堵，撤销处罚','2026-04-09 14:00:00',1,'2026-04-09 11:00:00','2026-04-10 10:47:56'),(6,16,15,'我承认当天开车确实有点急，因为前面有几个订单延误了。以后会注意安全驾驶，请给个机会',NULL,2,'驾驶安全是底线，不予撤销处罚，请务必注意安全驾驶','2026-04-10 16:00:00',1,'2026-04-10 14:30:00','2026-04-10 10:47:56'),(7,20,40,'我错了',NULL,1,'下不为例','2026-04-10 20:57:13',1,'2026-04-10 20:56:48','2026-04-10 20:56:48');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='投诉';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `driver_evaluation` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `order_id` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='司机评价乘客';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='司机扩展信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `driver_punish` (
  ...
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='司机处罚记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `driver_score_log` (
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='司机评分变更日志';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `eval_tag` (
  ...
  `is_deleted` tinyint DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='评价标签';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `evaluation` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `order_id` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='评价';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `evaluation_tag_relation` (
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=152 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='评价标签关联';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='订单信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sensitive_word` (
  ...
  `is_deleted` tinyint DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='敏感词';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统用户';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vehicle_info` (
  ...
  `is_deleted` tinyint DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='车辆信息';
/*!40101 SET character_set_client = @saved_cs_client */;
